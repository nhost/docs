...
If Magic Link Authentication is enabled and the user signs up without a password, the following response body is returned:
...
If Magic Link Authentication is enabled and the user logs in without a password, the following response body is returned:
