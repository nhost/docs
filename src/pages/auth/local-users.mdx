...
The easiest way for users to signup is using email/password. All user data will be saved in the database. New users will be added the `users` table and relevant account information will be saved in the tables under the `auth` schema.
