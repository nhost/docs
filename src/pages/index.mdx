...
Nhost was inspired by Google Firebase, but uses **SQL** and **GraphQL**. Also, a project is comprised of open-source software only, so **no vendor lock-in**.

## Get started

If you are new to Nhost we recommend the [quickstart guide](/quick-start/setup) where you build an app using Nhost and React.
