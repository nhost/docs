...
Since the `NhostApolloProvider` is now installed it's possible to use the Apollo client with it's `useQuery`, `useSubscription`, and `useMutation` functions anywhere in your app.
