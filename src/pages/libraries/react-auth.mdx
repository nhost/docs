...
description: Easy integration of Nhost with React.
---
...
We'll wrap routes that we want to protect for logged in users only using this component. In the example bellow only logged in users are allowed to access the `/`-route.
