...
All files in the storage are saved in [Minio S3](https://github.com/minio/minio), a high-performance object storage with a compatible AWS S3 API.

## Access

Storage is accessible with your backend URL under `/storage` (`https://backend-xxx.nhost.app/storage`).
